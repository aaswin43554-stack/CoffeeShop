                ...
                <div className="release-card">
                    <div className="release-details">
                        <div className="release-header">
                            <h2 className="release-title">Allocation R-014</h2>
                        ...
                        <div className="release-info-grid">
                            <div className="info-row">
                                ...
                                <span className="info-value">Natural Anaerobic</span>
                            </div>
                            <div className="info-row">
                                <span className="info-label">Roast Level</span>
                                <span className="info-value">Light</span>
                            </div>
                    ...
                    <div className="release-stats">
                        <div className="stats-header">
                            <span className="units-count">17 / 48</span>
