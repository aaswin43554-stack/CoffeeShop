...
const PRODUCTS = [
    ...
    {
        id: 'R-002',
        name: 'Boun Thateng, Laos',
        fullName: 'Boun Thateng, Laos Single Estate Specialty Coffee',
        price: 19.50,
        image: '/boun-thateng.jpg',
        estate: 'Boun Thateng',
        country: 'Laos',
        varietal: 'Typica',
        process: 'Washed',
        ...
        roast: 'Light',
        batchSize: '200g',
        totalBags: '36 Produced',
        flavors: ['Dark Chocolate', 'Brown Sugar', 'Dried Plum', 'Cedar'],
        story: 'From the Bolaven Plateau in southern Laos, the Boun Thateng estate produces a distinctively clean, sweet cup. The washed process highlights the terroir clarity while preserving a rich, chocolatey aftertaste.',
    },
];
